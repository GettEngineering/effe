...
func TestLogPlugin(t *testing.T) {
	...
	eTesting.RunTests(t, gen, "testdata", map[string][]byte{"github.com/GettEngineering/effe/testlogplugin/gen.go": dslGo}, []string{"github.com/GettEngineering/effe/testlogplugin"})
}
