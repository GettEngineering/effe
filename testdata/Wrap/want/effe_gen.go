...
func NewAImpl() *AImpl {
	return &AImpl{beforeStepFieldFunc: beforeStep(), failureStepFieldFunc: failureStep(), step1FieldFunc: step1(), step2FieldFunc: step2(), step3FieldFunc: step3(), successStepFieldFunc: successStep()}
}
